...
export const STRETCH_DEFINITIONS: StretchDefinition[] = [
  ...
  def(
    ...
    ['Glutes', 'Hip flexors'],
    '30–45 sec',
    'Lie on your back, knees bent, feet flat hip-width. Drive through heels to lift hips until shoulders, hips, and knees line up. Squeeze glutes at the top without arching the low back hard.',
    ['Legs', 'Core'],
  ),
  def(
    'Hip Bridge',
    ...
    ['Glutes', 'Hip flexors'],
    '30–45 sec',
    'Same setup as glute bridge: press hips up, ribs stay heavy, and breathe steadily at the top. Lower with control if you pulse reps.',
    ['Legs', 'Core'],
  ),
  def(
    'Dead Bug Stretch',
    ...
    ['Spine', 'Hip flexors'],
    '30–45 sec per side',
    'On your back, arms long overhead, opposite arm and leg reach away while the other limbs stay quiet. Move slow — this is a controlled lengthening, not a max crunch.',
    ['Core', 'Back'],
  ),
  def(
    'Doorway Pec Stretch',
    ...
    ['Chest'],
    '30–45 sec per side',
    'Forearm on a doorframe at shoulder height, elbow bent 90°. Step through until you feel the pec open; keep shoulder down and ribs from flaring forward.',
    ['Chest', 'Shoulders'],
  ),
  def(
    'Thread the Needle',
    ...
    '30–45 sec per side',
    'On all fours, slide one arm under the chest palm up, lowering shoulder and ear toward the floor. Hips stay level; rotate from the upper back.',
    ['Back', 'Shoulders', 'Core'],
  ),
  def(
    'Puppy Pose',
    'Spine & core',
    ['Lats', 'Spine', 'Shoulders'],
    '45–60 sec',
    'From hands and knees, walk hands forward and melt chest toward the floor while hips stay stacked over knees. Keep arms active and breathe into the side ribs.',
  ...
  def(
    ...
    ['Spine', 'Hip flexors'],
    '30–45 sec',
    'Lie prone, forearms on the floor under shoulders. Gently press chest forward and lengthen the front body without pinching the low back.',
    ['Back', 'Core'],
  ),
  def(
    ...
    ['Hip flexors'],
    '30–45 sec per side',
    'Half-kneel with front foot flat, rear knee down. Tuck pelvis, squeeze rear glute, and shift hips forward until the front of the rear hip opens.',
    ['Legs', 'Core'],
  ),
  def(
    'Pike Stretch',
    ...
    '30–45 sec',
    'Hips high in an inverted V — hands and feet on the floor, knees soft if needed. Press chest toward thighs while keeping the spine long.',
    ['Legs', 'Back', 'Shoulders'],
  ),
  def(
    ...
    ['Hamstrings', 'Spine'],
    '30–45 sec',
    'Feet hip-width, soft knees. Hinge and fold from the hips; let the head hang and breathe into the back of the legs.',
    ['Legs', 'Back'],
    { universal: true },
  ),
  def(
    ...
    ['Lats'],
    '30–45 sec per side',
    'Reach both arms overhead, grip one wrist with the opposite hand, and lean to that side. Keep ribs down and hips level.',
    ['Back', 'Shoulders'],
  ),
  def(
    'Wrist Circles',
    ...
    '10 reps each direction per wrist',
    'Extend one arm, make slow circles with the wrist through a comfortable range. Switch direction and wrists.',
    ['Arms'],
  ),
  def(
    ...
    ['Spine', 'Glutes'],
    '30–45 sec per side',
    'On your back, hug one knee toward the chest while the other leg stays long or bent. Relax shoulders and breathe into the low back.',
    ['Back', 'Core', 'Legs'],
  ),
  def(
    'Seated Butterfly',
    ...
    ['Adductors', 'Hips'],
    '30–45 sec',
    'Sit tall with soles together and knees wide. Hold ankles, lengthen the spine, and let knees drop only as far as inner thighs allow — no bouncing.',
    ['Legs'],
  ),
  def(
    'Reclined Pigeon',
    ...
    '45–60 sec per side',
    'On your back, cross ankle over opposite knee and draw the support thigh toward you. Keep head and shoulders relaxed on the floor.',
    ['Legs'],
  ),
  def(
    'Happy Baby Pose',
    ...
    ['Hips', 'Adductors'],
    '45–60 sec',
    'On your back, grab the outer edges of the feet, knees wide toward armpits. Keep tailbone heavy and sacrum on the floor.',
    ['Legs', 'Core'],
  ),
  def(
    'Legs Up the Wall',
    ...
    ['Hamstrings', 'Calves'],
    '2–5 min',
    'Sit beside a wall, swing legs up, hips a few inches from the wall. Let legs relax vertical; breathe slowly.',
    ['Legs', 'Back'],
    { universal: true },
  ),
  def(
    ...
    ['Hamstrings'],
    '30–45 sec per side',
    'On your back, loop a strap or towel around the foot. Keep the lifted leg straight and hip grounded as you draw the leg toward you.',
    ['Legs'],
  ),
  def(
    ...
    ['Lats', 'Spine'],
    '30 sec per side',
    'Feet hip-width, reach one arm overhead and lean to the opposite side. Keep hips square and glutes engaged.',
    ['Back', 'Core', 'Shoulders'],
  ),
  def(
    'Low Lunge Twist',
    ...
    ['Hip flexors', 'Thoracic spine'],
    '30–45 sec per side',
    'Low lunge with rear knee down. Place the opposite hand on the floor inside the front foot and rotate the torso toward the front leg, reaching the top arm up.',
    ['Legs', 'Back', 'Core'],
  ),
]
