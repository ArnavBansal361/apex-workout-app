...
export function HelpPage({ onClose }: Props) {
  ...
  return (
    <div className="fixed inset-0 z-[90] flex flex-col bg-[#0c0c0c]" style={{ ['--accent' as string]: accent }}>
      <header className="px-4 pt-3 pb-2 border-b border-[#1e1e1e] space-y-2">
        ...
        <input
          className="w-full min-h-12 rounded-[12px] border border-[#1e1e1e] bg-[#161616] px-3 text-[13px] text-[#e0e0e0] placeholder:text-[#888]"
            ...
            <details key={e.id} className="apex-card p-4">
              <summary className="cursor-pointer list-none flex justify-between gap-2 min-h-12 items-start">
                <div>
                  ...
                  <span className="text-[11px] text-[#bdbdbd] mt-0.5 block">{e.muscleGroup}</span>
                </div>
              ...
              <div className="mt-4 border-t border-[#1e1e1e] pt-4 space-y-4">
                ...
                <div>
                  ...
                  <p className="text-[11px] font-normal text-[#bdbdbd] leading-relaxed">{h.formTips}</p>
                </div>
                <div>
                  <p className="apex-section-label mb-2">Common mistakes</p>
                  <p className="text-[11px] font-normal text-[#bdbdbd] leading-relaxed">{h.commonMistakes}</p>
                </div>
                <div>
                  <p className="apex-section-label mb-2">Beginner advice</p>
                  <p className="text-[11px] font-normal text-[#bdbdbd] leading-relaxed">{h.beginnerAdvice}</p>
                </div>
              </div>
            </details>
          )
