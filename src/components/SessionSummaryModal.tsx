      ...
      <div className="w-full max-w-md space-y-4" onClick={(e) => e.stopPropagation()}>
        <div ref={cardRef} className="apex-card p-6">
          ...
          <div className="mt-6 grid grid-cols-2 gap-3">
            <div className="rounded-[12px] border-[0.5px] border-[var(--apex-border)] bg-[var(--apex-surface-nested)] px-4 py-3">
          ...
          {data.exerciseNames.length > 0 ? (
            <div className="mt-5 rounded-[12px] border-[0.5px] border-[var(--apex-border)] bg-[var(--apex-surface-nested)] p-3">
              <p className="apex-section-label mb-2">Exercises</p>
