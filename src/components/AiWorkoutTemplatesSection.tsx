...
export function AiWorkoutTemplatesSection({ enabled }: Props) {
  ...
  return (
    <div className="space-y-3">
      ...
      {error ? (
        <div className="rounded-[12px] border-[0.5px] border-red-900/40 bg-red-950/20 px-4 py-3">
      ...
      {templates?.map((tpl) => {
        ...
        return (
          <div
            key={tpl.id}
            className="rounded-[12px] border-[0.5px] border-white/[0.07] bg-white/[0.03] overflow-hidden"
          >
            <button
              type="button"
