...
export const ACHIEVEMENT_DEFS = [
  ...
  { id: 'streak-30', title: '30-Day Streak', description: 'Train at least once per day for 30 days.' },
  { id: 'sets-500', title: '500 Sets', description: 'Log 500 total sets.' },
  { id: 'sets-1000', title: '1,000 Sets', description: 'Log 1,000 total sets. You live in the gym.' },
  { id: 'longevity-50', title: 'Longevity 50', description: 'Reach a Longevity Score of 50.' },
  { id: 'longevity-80', title: 'Longevity 80', description: 'Reach a Longevity Score of 80.' },
  { id: 'triple-pr', title: 'Triple Threat', description: 'Set PRs in bench, squat, and deadlift.' },
  { id: 'cardio-60', title: 'Cardio Block', description: 'Log 60 minutes of cardio in a single week.' },
  { id: 'leg-day-hero', title: 'Leg Day Hero', description: 'Log 10 leg day sessions.' },
  { id: 'deload-week', title: 'Smart Recovery', description: 'Complete a full deload week.' },
  { id: 'coach-chat', title: 'Ask the Coach', description: 'Send your first message to the AI Coach.' },
  { id: 'schedule-full', title: 'Planner', description: 'Fill out every day of your weekly schedule.' },
] as const
